...
struct GL20 {
    ...
    virtual void glUniform2f(int &location, float &x) = 0;
    ...
    virtual void glUniform2i(int &location, int &x) = 0;
    ...
    virtual void glUniform3f(int &location, float &x) = 0;
    ...
    virtual void glUniform3i(int &location, int &x) = 0;
    ...
    virtual void glUniform4f(int &location, float &x) = 0;
    ...
    virtual void glUniform4i(int &location, int &x) = 0;
